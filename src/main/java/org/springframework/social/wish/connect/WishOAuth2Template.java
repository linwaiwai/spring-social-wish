...
public class WishOAuth2Template extends OAuth2Template {
 
	public WishOAuth2Template(String clientId, String clientSecret, String authorizeUrl, String accessTokenUrl) {
...
// Retrieves object from map into an Integer, regardless of the object's actual type. Allows for flexibility in object type (eg, "3600" vs 3600).
	...
	protected AccessGrant postForAccessGrant(String accessTokenUrl, MultiValueMap<String, String> parameters) {
		return facebookExtractAccessGrant(getRestTemplate().postForObject(accessTokenUrl, parameters, Map.class));
	}
	
	private AccessGrant facebookExtractAccessGrant(Map<String, Object> data) {
		@SuppressWarnings("unchecked")
