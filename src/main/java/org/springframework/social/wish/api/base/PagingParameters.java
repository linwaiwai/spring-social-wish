...
public class PagingParameters implements Serializable {
	 ...
	 */
	public PagingParameters(Integer limit, Integer start, Long since, Long until) {
		this(limit, start, since, until, null, null, null, null);
	}
	 ...
	 */
	public PagingParameters(Integer limit, Integer start, Long since, Long until, String after, String before, String pagingToken, String fullUrl) {
		this.limit = limit;
		this.start = start;
		this.since = since;
		this.until = until;
	...
	public MultiValueMap<String, String> toMap() {
		...
		if (start != null) { map.set("start", String.valueOf(start)); }
