...
import org.springframework.social.wish.api.impl.json.WishResolveDataModule;
...
public class WishTemplate extends AbstractOAuth2ApiBinding implements Wish {
	...
	private VariantOperations variantOperations;
...
//	private String applicationNamespace;
	...
	private void initSubApis() {
		...
		variantOperations = new VariantTemplate(this);
	}
	 ...
	 */
	public WishTemplate(String accessToken) {
		
		this(accessToken, null);
		
	}

	public WishTemplate(String accessToken, String applicationNamespace) {
...
//		registerOAuth2Interceptor(accessToken);
	...
	public WishTemplate(String accessToken, String applicationNamespace, String appId) {
		super(accessToken);
//		this.applicationNamespace = applicationNamespace;
	...
	public VariantOperations variantOperations(){
	...
	/**
	 * Fetches the next {@link org.springframework.social.wish.api.base.PagedList PagedList} of the current one.
	 * @param page source {@link org.springframework.social.wish.api.base.PagedList PagedList} to fetch the next one.
	 * @param type type of the source {@link org.springframework.social.wish.api.base.PagedList PagedList} and the next one.
	 * @param <T> the type of the source
	 * @return the next {@link org.springframework.social.wish.api.base.PagedList PagedList} of the given one.
	 * It returns <code>null</code> if the next {@link org.springframework.social.wish.api.base.PagedList PagedList} doesn't exist.
	 */
	...
	/**
	 * Fetchs the previous {@link org.springframework.social.wish.api.base.PagedList PagedList} of the current one.
	 * @param page source {@link org.springframework.social.wish.api.base.PagedList PagedList} to fetch the previous one.
	 * @param type type of the source {@link org.springframework.social.wish.api.base.PagedList PagedList} and the previous one.
	 * @return the previous {@link org.springframework.social.wish.api.base.PagedList PagedList} of the given one.
	 * @param <T> the type of the source
	 * It returns <code>null</code> if the previous {@link org.springframework.social.wish.api.base.PagedList PagedList} doesn't exist.
	 */
...
//	}
	...
	public <T> T post(String objectId, Class<T> type, MultiValueMap<String, String> data) {
//		String connectionPath = connectionType != null ? "/" + connectionType : "";
		URI uri = URIBuilder.fromUri(getBaseGraphApiUrl() + objectId ).build();
		return getRestTemplate().postForObject(uri, new LinkedMultiValueMap<String, String>(data), type);
	}
	...
	protected void configureRestTemplate(RestTemplate restTemplate) {
		restTemplate.setErrorHandler(new WishErrorHandler());
	}
...
//		objectMapper = Jackson2ObjectMapperBuilder.json().build();
		...
		objectMapper.registerModule(new WishModule());
		objectMapper.registerModule(new WishResolveDataModule());	
		return converter;
	}
